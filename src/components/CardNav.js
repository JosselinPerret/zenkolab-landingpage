...
// lightweight inline arrow icon to avoid extra dependency on react-icons
      ...
      <nav ref={navRef} className={`card-nav ${isExpanded ? 'open' : ''}`} style={{ backgroundColor: baseColor }}>
        <div className="card-nav-top">
          ...
          <div className="logo-container">
            {logo ? <img src={logo} alt={logoAlt} className="logo" /> : <div className="logo-fallback">{logoAlt}</div>}
          </div>
