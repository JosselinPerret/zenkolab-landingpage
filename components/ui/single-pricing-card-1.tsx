...
export function Pricing() {
	return (
		<section className="relative min-h-screen overflow-hidden py-10 md:py-24">
					...
					>	
						<div className="grid md:grid-cols-2 bg-background relative border p-4">
							...
							<div className="w-full px-4 pt-5 pb-4">
								<div className="space-y-1">
									<div className="flex items-center justify-between">
										<h3 className="leading-none font-semibold">Pilote</h3>
								...
								<div className="mt-10 space-y-4">
									<div className="text-muted-foreground flex items-end gap-0.5 text-xl">
										<span className="text-foreground -mb-0.5 text-2xl font-extrabold tracking-tighter md:text-3xl">
											Gratuit
										</span>
									</div>
							...
							<div className="relative w-full rounded-lg border px-4 pt-5 pb-4">
								...
								<div className="space-y-1">
									<div className="flex items-center justify-between">
										<h3 className="leading-none font-semibold">Déploiement</h3>
										<div className="flex items-center gap-x-1">
											<Badge>Complet</Badge>
										</div>
									</div>
